  ...
  return (
    ...
    >
      <div className=" flex flex-col items-center justify-center">
        ...
        <h1 style={{ fontFamily: '"Pacifico", cursive' }} className="text-5xl text-center dark:text-white text-nav_bg font-semibold italic">Thrilling Tourists Spots</h1>
      </div>
      <div className=" w-full px-2 lg:w-3/4 mx-auto mt-16 relative">
        ...
        >
          ...
          <div className="mt-5 flex items-center justify-between">
            <button id="prev" className="px-5 py-3 hover:underline bg-card_bg/75 backdrop:blur-2xl">
              <GrFormPreviousLink className="text-xl font-semibold" />
            </button>
            <button id="next" className="px-5 py-3 hover:underline bg-card_bg/75 backdrop:blur-2xl">
              <GrFormNextLink className="text-xl font-semibold" />
            </button>
          </div>
        </Swiper>
        <div className="flex items-center justify-between text-center w-full">
        <Link to={'/allTouristSpots'} className="mt-5 px-5 py-3 bg-btn_bg/75 w-40 mx-auto">Explore More</Link>
        </div>
      </div>
    </section>
  );
